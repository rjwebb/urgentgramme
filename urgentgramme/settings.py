"""
Django settings for urgentgramme project.
...
SECURE_CHECKS = [
    ...
    "urgentgramme.checks.check_session_csrf_enabled",
    "urgentgramme.checks.check_csp_is_not_report_only"
]
...
ROOT_URLCONF = 'urgentgramme.urls'

WSGI_APPLICATION = 'urgentgramme.wsgi.application'
